const BYTEWATT_POLICY_CARD_BUILD = "035";
...
class ByteWattPolicyCard extends HTMLElement {
  ...
  _renderSummary(attrs) {
    ...
    const chargeWatts = Number.isFinite(batteryPower) && batteryPower > 0 ? batteryPower : 0;
    const dischargeWatts = Number.isFinite(batteryPower) && batteryPower < 0 ? Math.abs(batteryPower) : 0;
