const BYTEWATT_POLICY_CARD_BUILD = "023";
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .policy-value.immediate-value .field-helper {
          display: inline-flex;
          align-items: center;
          justify-content: center;
          min-width: 20px;
          ...
          enabled
            ? `
              <div class="policy-grid charge-policy-grid">
                ...
                ${this._numberCell("Charge Power (W)", this._config.charge_power, "charge", "W")}
              </div>
            `
          ...
          enabled
            ? `
              <div class="policy-grid discharge-policy-grid">
                ...
                ${this._numberCell("Discharge Power (W)", this._config.discharge_power, "discharge", "W")}
              </div>
            `
      ...
      `
        ...
        <div class="stack">
          ...
          ${this._immediatePairFields([
            ...
            {
              label: "Immediate Feed-in Power (W)",
  ...
  _numberInput(key, value, unit, disabled = false) {
    ...
    return `
      <div class="policy-value immediate-value ${unitClass}">
        ...
        <div class="field-helper">${this._escapeHtml(unit)}</div>
      </div>
    `;
  }
